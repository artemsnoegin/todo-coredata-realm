...
Учебное iOS-приложение для управления списком задач (ToDo), разработанное для практики работы с CoreData и Realm. Приложение позволяет создавать группы задач и управлять отдельными элементами внутри них.
